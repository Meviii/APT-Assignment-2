...
int main(void){
    ...
    std::cout << "Printing size of board dimension:" << std::endl;
    std::cout << "Board is " << gb->testGetSize() << " x " << gb->testGetSize() << std::endl;
    ...
    std::cout << "Placing tile 'A' at Pos (D,3) i.e. Co-ords (3,3) and printing the game board state:" << std::endl;
